...
import com.ets.bfd.visitor.activity.MyTicketViewActivity;
import com.ets.bfd.visitor.activity.OneDayTourTicket;
import com.ets.bfd.visitor.activity.OverNightTour;
import com.ets.bfd.visitor.activity.RegistrationAndRenewApplication;
...
//        setFontAwesomeIcon(context, nav_Menu.findItem(R.id.changePassword), R.string.fa_key);
        ...
        MenuItem menuVesselRenewAndReg = nav_Menu.findItem(R.id.btn_regAndRenew);
        MenuItem menuTourPermission = nav_Menu.findItem(R.id.btn_tourPermissionApplication);
        MenuItem menuBookingList = nav_Menu.findItem(R.id.idBookingList);
        MenuItem menuMyProfile = nav_Menu.findItem(R.id.myProfile);
        MenuItem menuDashboard = nav_Menu.findItem(R.id.dashboard);
        MenuItem menuMyTicket = nav_Menu.findItem(R.id.myTicket);
        ...
        if (!preferences.getUserId().isEmpty()) {
            ...
            menuBookingList.setVisible(true);
            menuMyProfile.setVisible(true);
            menuMyTicket.setVisible(true);
            if (preferences.getExternalUserType().equalsIgnoreCase("operator")) {
                menuVesselRenewAndReg.setVisible(true);
                menuTourPermission.setVisible(true);

            }
        } else {
            menulogIn.setVisible(true);
            menuLogout.setVisible(false);
            menuVesselRenewAndReg.setVisible(false);
            menuTourPermission.setVisible(false);
            menuBookingList.setVisible(false);
            menuMyProfile.setVisible(false);
            menuMyTicket.setVisible(false);
        }
        ...
        nv.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (id) {
                    ...
                    case R.id.myTicket:
                        context.startActivity(new Intent(context, MyTicketActivity.class));
                        activity.finish();
                        break;
                    ...
                    case R.id.btn_tourPermissionApplication:
                        context.startActivity(new Intent(context, TourPermissionApplicationForm.class));
                        activity.finish();
                        break;
                  ...
                  /*  case R.id.changePassword:
                    ...
                    case R.id.idOneDayTourTicket:
                        OneDayTourTicket.GrandTotal = 0;
                        context.startActivity(new Intent(context, OneDayTourTicket.class));
                        break;

                    case R.id.idOverNight:
                        context.startActivity(new Intent(context, AllPackageList.class));
                        break;

                    case R.id.idBookingList:
